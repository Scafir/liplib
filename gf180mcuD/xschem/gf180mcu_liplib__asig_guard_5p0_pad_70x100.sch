...
N 160 -120 160 -80 {lab=#net1}
N 160 -20 160 20 {lab=pad}
N 160 80 160 120 {lab=#net1}
...
N 440 100 540 100 {lab=pad_guard}
N 440 100 440 140 {lab=pad_guard}
N 440 -140 440 -100 {lab=pad_guard}
N 440 -100 500 -100 {lab=pad_guard}
N 500 -100 500 100 {lab=pad_guard}
N 360 100 440 100 {lab=pad_guard}
N 330 80 380 80 {lab=pad_guard}
N 380 80 380 100 {lab=pad_guard}
N 330 -100 330 -20 {lab=pad_guard}
N 330 -100 440 -100 {lab=pad_guard}
N 240 -0 300 -0 {lab=pad}
N 160 100 300 100 {lab=#net1}
N 220 -100 220 100 {lab=#net1}
N 160 -100 220 -100 {lab=#net1}
N 0 -240 40 -240 {lab=VDD}
N 0 260 40 260 {lab=VSS}
C {iopin.sym} 0 0 2 0 {name=p1 lab=pad}
C {iopin.sym} 540 100 0 0 {name=p2 lab=pad_guard}
...
C {symbols/diode_nd2ps_06v0.sym} 440 170 2 0 {name=D16
model=diode_nd2ps_06v0
r_w=1u
r_l=12u
m=1}
C {symbols/diode_pd2nw_06v0.sym} 440 -170 2 0 {name=D17
model=diode_pd2nw_06v0
r_w=1u
r_l=12u
m=1}
...
r_l=12u
m=1}
C {symbols/ppolyf_u_1k_6p0.sym} 330 100 1 0 {name=R3
W=2e-6
L=2e-6
model=ppolyf_u_1k_6p0
spiceprefix=X
m=1}
C {symbols/ppolyf_u_1k_6p0.sym} 330 0 1 0 {name=R1
W=2e-6
L=2e-6
model=ppolyf_u_1k_6p0
spiceprefix=X
m=1}
C {noconn.sym} 40 -240 2 0 {name=l1}
C {noconn.sym} 40 260 2 0 {name=l2}
